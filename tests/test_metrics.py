...
def test_capital_cost():
    exp = pd.DataFrame(np.array([
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -8, 0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -7, 343.75),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -6, 687.5),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -5, 1031.25),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -4, 1375.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -3, 1718.75),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -2, 2062.5),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, -1, 2406.25),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, 0, 2750.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, 1, 1375.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 13, 2, 0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 9, 0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 10, 750.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 11, 1500.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 12, 2250.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 13, 3000.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 14, 3750.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 15, 4500.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 16, 5250.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 17, 6000.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 18, 3000.0),
        (UUID('f22f2281-2464-420a-8325-37320fd418f8'), 20, 19, 0)
        ], dtype=ensure_dt_bytes([
             ('SimId','O'), ('AgentId', '<i8'), ('Time','<i8'),
             ('CashFlow', '<f8')]))
        )
